    ...
    <div className="h-full bg-white/60 backdrop-blur-lg border border-white/60 rounded-xl p-6 relative overflow-hidden flex flex-col shadow-sm custom-glass-scrollbar overflow-y-auto max-h-[75vh]">
      ...
      <div className="space-y-6 flex-grow">
        {orders.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white/40 border border-white/60 rounded-xl shadow-inner">
            <Package className="mx-auto text-gray-400 mb-3" size={32} />
            <p className="text-gray-500 font-sans text-sm">Bạn chưa có đơn đặt hàng nào.</p>
          </div>
        )}
      </div>
    </div>
