...
import { Globe, Layers, Brush, ArrowUpRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs text-gray-600 font-sans">
            ...
            <li>
              <button onClick={() => { setActiveTab('contact'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="hover:underline text-left">
